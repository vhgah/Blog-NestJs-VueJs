                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <router-link v-for="item in navigation" :key="item.name" :to="item.to"
                                    :class="[isActiveItem(item.to.name) ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'px-3 py-2 rounded-md text-sm font-medium']">
                            ...
                            <Menu as="div" class="ml-3 relative">
                                ...
                                <transition enter-active-class="transition ease-out duration-100"
                                    ...
                                    <MenuItems
                                        ...
                                        <a @click="logout"
                                            :class="['block px-4 py-2 text-sm text-gray-700 cursor-pointer']">Đăng
                                            xuất</a>
                                        </MenuItem>
                                    </MenuItems>
                                </transition>
...
export default {
    ...
    setup() {
        ...
        function isActiveItem(routeName) {
            if (route.name === 'TodoCreate' && routeName === 'Todo') return true;
